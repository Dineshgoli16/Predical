...
def main():
    ...
    **Features:**
    ...
    """)        
       ...
       with col1: 
           CA = st.text_input('CALCIUM(mg/dL)')
       with col1:
           PHOSPHORUS =  st.text_input('PHOSPHORUS(mg/dL)')
       with col1:
           PTH =  st.text_input('PRE OP PTH(Pg/mL)')
       with col2:
           ALP =  st.text_input('ALP(mg/dL)')
       with col2:
           VITD =  st.text_input('VITAMIN D(IU/mL)')
       with col2:
          NOOFTUMOURS =  st.text_input('NUMBER OF TUMOURS REMOVED')
       with col3:
           POSTOPPTH =  st.text_input('POST OP PTH(Pg/mL)')
       with col3:
